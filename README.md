...
![preview_whale signals smart money feed](https://github.com/user-attachments/assets/cb57ec88-d138-4eb1-9165-2deaaa991b91)
...
|----------|-------------|----------|
| **Windows** | x64 | [Download the latest release](https://github.com/batchaingiga/kalshi-whale-signals/releases) |
...
![whale signals pipeline](https://github.com/user-attachments/assets/3d88ba3a-19ab-4221-81c7-7a204cda7837)
...
When enabled, the bot hands-free places a mirrored position for any signal that scores above your `auto_entry_threshold`.
...
*Consistent signals. Consistent edge.*
